...
All entries go into the **Gotchas** section as bullet points. Only create a separate section if the topic is clearly out of scope for gotchas (e.g. a multi-step workflow). Do not add new h2 sections without asking the user first.
